        ...
        <div className="page-header clear-filter" data-filter-color="orange">
            ...
            <div className="container">
              ...
              <h6 className="category category-absolute">Designed by
                ...
                <img src="./assets/img/invision-white-slim.png" className="invision-logo" />
                </a>. Coded by
                <a href="https://www.creative-tim.com" target="_blank">
                <img src="./assets/img/creative-tim-white-slim2.png" className="creative-tim-logo" />
                </a>.
              </h6>
            </div>
        </div>
...
{/* Typography */}
                  ...
                  <div id="images">
                    ...
                    <div className="row">
                        <div className="col-sm-2">
                          ...
                          <img src="./assets/img/julie.jpg" alt="Rounded Image" className="rounded" />
                        </div>
                        <div className="col-sm-2">
                          <p className="category">Circle Image</p>
                          <img src="./assets/img/julie.jpg" alt="Circle Image" className="rounded-circle" />
                        </div>
                        <div className="col-sm-2">
                          <p className="category">Raised</p>
                          <img src="./assets/img/julie.jpg" alt="Raised Image" className="rounded img-raised" />
                        </div>
                        <div className="col-sm-2">
                          <p className="category">Circle Raised</p>
                          <img src="./assets/img/julie.jpg" alt="Thumbnail Image" className="rounded-circle img-raised" />
                        </div>
                    </div>
                  </div>
              </div>
            ...
            <div className="section section-signup" style={{backgroundImage: "url('assets/img/bg11.jpg')", backgroundSize: "cover", backgroundPosition: "top center", minHeight: "700px"}}>
              <div className="container">
                  <div className="row">
