    ...
    <div className="root">
      ...
      <div className="wrapper">
        ...
        <div className="main">
            ...
            <div className="section section-signup" style="background-image: url('assets/img/bg11.jpg'); background-size: cover; background-position: top center; min-height: 700px;">
              <div className="container">
                  <div className="row">
